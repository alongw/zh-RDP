...
//     File     : Microsoft/Telemetry/Extensions/os.java
//
...
public class os extends Microsoft.Telemetry.Extension {
    // TODO: implement
    ...
    // 10: Optional string locale
    private String locale;

    // 20: Optional string expId
    ...
    */
    ...
    public void writeNested(com.microsoft.bond.ProtocolWriter writer, boolean isBase) throws java.io.IOException {
        ...
        if (!canOmitFields || (locale != Schema.locale_metadata.getDefault_value().getString_value())) {
            writer.writeFieldBegin(com.microsoft.bond.BondDataType.BT_STRING, 10, Schema.locale_metadata);
            writer.writeString(locale);
            writer.writeFieldEnd();
        } else {
            writer.writeFieldOmitted(com.microsoft.bond.BondDataType.BT_STRING, 10, Schema.locale_metadata);
        }

        if (!canOmitFields || (expId != Schema.expId_metadata.getDefault_value().getString_value())) {
            writer.writeFieldBegin(com.microsoft.bond.BondDataType.BT_STRING, 20, Schema.expId_metadata);
            writer.writeString(expId);
            writer.writeFieldEnd();
        } else {
            writer.writeFieldOmitted(com.microsoft.bond.BondDataType.BT_STRING, 20, Schema.expId_metadata);
        }
