...
public interface ICll
{
     ...
     * @param ids
     */
    void log(Base event, List<String> ids);
     ...
     * @param ids
     */
    void log(String eventName, String eventData, Latency latency, Persistence persistence, EnumSet<Sensitivity> sensitivity, double sampleRate, List<String> ids);
